...
Tras analizar las plantas 1 y 2 observamos:
...
- Índice de Demanda Diaria (IDD) para guiar decisiones operativas.
  - Consumo: ajuste dinámico de cantidades cargadas por vuelo (menos desperdicio y quiebres).
  - Productividad: estimación de personal diario recomendado para estabilizar la operación.
